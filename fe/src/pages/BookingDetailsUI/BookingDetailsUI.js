  ...
  const handleNextPayment = async () => {
    ...
    try {
      const res = await axios.post(
        "https://whitesmoke-shark-473197.hostingersite.com/api/insertbooking",
        {
          userid: user.userid,
          propertyid,
          ...
          checkout_date,
          total_price:
            propertyData.property_unitdetails[0].unitpricing.min_price,
      ...
      if (res.data.status === "success") {
        const res2 = await axios.post(
          "https://whitesmoke-shark-473197.hostingersite.com/api/create-payment-link",
          {
            amount:
              propertyData.property_unitdetails[0].unitpricing.min_price * 100,
