...
function BookingGuest({ User, onGuestDetailsChange, PropertyData }) {
  ...
  useEffect(() => {
    ...
    setFirstName(dummyUserData.firstname);
    setLastName(dummyUserData.lastname);
  }, []);
  ...
  return (
    ...
    <Box p={5} bgcolor="white" sx={{borderRadius:'8px', marginTop:'24px', borderColor:'black',boxShadow: '0 0.5rem 1rem rgba(0, 0, 0, 0.15)'}}>
      ...
      <Card sx={{ border: '0.1rem solid rgba(0, 0, 0, 0.1)', padding: '1rem', borderRadius: '0.6rem', mt: 3, width: '100%', boxShadow: '0 0.3rem 0.8rem rgba(0, 0, 0, 0.15)', marginTop:'-4px' }}>
      ...
      <Card sx={{ border: '0.1rem solid rgba(0, 0, 0, 0.1)', padding: '1rem', borderRadius: '0.6rem', mt: 3, width: '100%', boxShadow: '0 0.3rem 0.8rem rgba(0, 0, 0, 0.15)' }}>
        <Stack direction="row" spacing={2} alignItems="stretch" justifyContent="left" width="100%">
          <div style={{ width: '100%' }}>
            <Typography sx={{ fontSize: '1rem', mb: '0.5rem', fontWeight: 'bold' }}>First Name</Typography>
            <TextField fullWidth color={firstName ? "success" : "primary"} focused value={firstName} onChange={handleFirstNameChange} InputProps={{ endAdornment: firstName ? <InputAdornment position="end"><CheckIcon color="success" /></InputAdornment> : null }} />
          </div>
          <div style={{ width: '100%' }}>
            <Typography sx={{ fontSize: '1rem', mb: '0.5rem', fontWeight: 'bold' }}>Last Name</Typography>
            <TextField fullWidth color={lastName ? "success" : "primary"} focused value={lastName} onChange={handleLastNameChange} InputProps={{ endAdornment: lastName ? <InputAdornment position="end"><CheckIcon color="success" /></InputAdornment> : null }} />
          </div>
        </Stack>
        <Stack direction="column" fullWidth>
          <div style={{ width: '49%', marginTop: '1rem' }}>
      ...
      <Card 
      sx={{ padding: '1rem', borderRadius: '0.6rem', mt: 3, width: '100%', boxShadow: '0 0.5rem 1rem rgba(0, 0, 0, 0.15)' }}>
        <Typography sx={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Property Type</Typography>
        <Typography sx={{ fontSize: '1rem', mt: '1rem' }}>
          Policies:
          <ul>
        ...
        {bookingFor === 'myself' ? (
          ...
          <Grid item xs={12} sm={6}>
            <Typography sx={{ fontSize: '1rem', mb: '0.5rem', fontWeight: 'bold' }}>Guest Name</Typography>
