...
const Popular = (props) => {
  return (
    // <div className="frame471-container">
      <div className="frame481-frame481" style={{backgroundColor:'lightblue', stroke:'ActiveBorder'}}>
        <div className="frame471-group214" style={{justifyContent:'center'}}>
          <span className="frame481-text" style={{justifyContent:'center', margin:'0px', marginTop:'1rem'}}>
            Nearby Places
          </span>
          <span className="frame471-text02" style={{margin:'0px', marginTop:'0.5rem'}}>
