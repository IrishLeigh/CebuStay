          ...
          >
            <Stack direction="column">
              ...
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '1.125rem' }}>{reservation.property_type}</Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <CheckIcon sx={{ fontSize: '1.125rem', mr: 1 }} />
                <Typography sx={{ fontSize: '1.125rem' }}>{reservation.unit_type}</Typography>
              </Box>
            </Stack>
            <Paper
              sx={{
          ...
          <TableContainer component={Paper} sx={{ mt: 2 }}>
            <Table>
              <TableHead sx={{ backgroundColor: '#A334CF', color: 'white' }}>
                <TableRow>
                  <TableCell sx={{ fontWeight: 'bold' ,  color: 'white'}}>Number of Guests</TableCell>
                  <TableCell sx={{ fontWeight: 'bold' ,  color: 'white'}}>Nights</TableCell>
