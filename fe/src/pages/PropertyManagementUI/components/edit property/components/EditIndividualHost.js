...
export default function IndividualHost({
  ...
  useEffect(() => {
    ...
    if (parentData && parentData.property_owner) {
      ...
      setOriginalData({
        ...
        propertyownershipid:
          parentData.property_ownership?.propertyownershipid || null,
      ...
      console.warn(
        "parentData or parentData.property_owner is undefined or null"
      );
    }
  }, [parentData]);
  ...
  const handleSaveImage = async () => {
    try {
      ...
      setData((prevData) => ({
        ...prevData,
        imageSrc: URL.createObjectURL(croppedImage),
      }));
    } catch (e) {
      console.error(e);
    }
