  ...
  const validateAndProceed = () => {
    ...
    if (hostType === "Individual") {
      if (
        ...
        individualData.DisplayName == "" ||
        individualData.Describe == ""
      ) {
        setHasError(true);
        errorMessage.push(
          "Please fill out all the required fields for the individual host."
        );
        setSnackbarMessage(
          "Please fill out all the required fields for the individual host."
        );
      ...
      if (!phonePattern || !phonePattern.test(PhoneNumber)) {
        setHasError(true);
        errorMessage.push(
          "Invalid phone number. Please ensure it matches the format for the selected country code."
        );
        setSnackbarMessage(
          "Invalid phone number. Please ensure it matches the format for the selected country code."
        );
