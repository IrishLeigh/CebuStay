...
import { Grid, InputLabel, Checkbox, TextField, Box, Typography, Paper, Button } from "@mui/material";

export default function RulesPolicies({ houseRules, policies, onHouseRulesChange, onPoliciesChange }) {
  ...
  useEffect(() => {
    if (houseRules) {
      ...
      setOriginalData((prevData) => ({ ...prevData, houseRulesData: initialHouseRulesData }));
      setShowTimePicker(houseRules.quiet_hours_start && houseRules.quiet_hours_end);
    }
  }, [houseRules]);
  ...
  useEffect(() => {
    if (policies) {
      ...
      setOriginalData((prevData) => ({ ...prevData, policiesData: initialPoliciesData }));
    }
  }, [policies]);
  ...
  return (
    <Paper style={{ width: "auto", padding: "4rem", borderRadius: "0.8rem", alignItems: "center" }}>
      ...
      <Typography sx={{ fontFamily: "Poppins, sans-serif", fontSize: "0.875rem", color: "#6b7280", marginBottom: "2rem" }}>
        Update your property's house rules and booking policies here. Set rules for smoking, pets, and quiet hours, and define cancellation terms and refund policies. Make sure to save your changes.
      </Typography>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sx={{ padding: "1rem" }}>
          <div style={{ marginBottom: "1rem" , padding : "0 2rem 2rem 2rem", border: "1px solid #ccc",borderRadius: "0.8rem", paddingTop: "1rem"}}>
            ...
            <Box>
              <InputLabel sx={{ marginRight: 2 }}>Cancellation and prepayment policies</InputLabel>
              <Checkbox
              ...
              />
              <br />
              <InputLabel sx={{ marginRight: 2 }}>Modification Plans</InputLabel>
              <Checkbox
