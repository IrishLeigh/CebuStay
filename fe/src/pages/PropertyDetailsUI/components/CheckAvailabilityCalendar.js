...
const CheckAvailabilityCalendar = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const propertyres = await axios.get(
          "https://whitesmoke-shark-473197.hostingersite.com/api/property/allbookings",
          {
            params: {
  ...
  const handleOpen = (info) => {
    ...
    const propertyDetails = propertyTypes.find(
      (property) => property.bookingid == info.event.extendedProps.bookingid
    );
