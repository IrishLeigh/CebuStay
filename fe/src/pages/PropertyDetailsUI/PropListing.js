...
export default function ViewPropertyListing() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(`http://127.0.0.1:8000/api/getfiles/59`);
        if (res.data) {
  ...
  const handleReserveClick = () => setShowReservationForm(true);
