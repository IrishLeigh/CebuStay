...
function MultiUnitFacilities({ onAmenitiesChange, parentAmenities, handleBack, handleNext }) {
    ...
    <>
      ...
      >
        ...
        <Typography sx={{ fontSize: "1.5rem", mb: 2 }}>
          These are facilities that are shared between multiple units.
        </Typography>
        <CategorySection
          category="facilities"
          label={"Facilities"}
...
export default MultiUnitFacilities;
